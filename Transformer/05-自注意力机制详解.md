...
- 左图（热力图）：每行代表一个Query对所有Key的注意力权重，颜色越深权重越高
- 右图（柱状图）：直观展示每个Query对不同Key的关注程度
...
```
==================================================
Example 1: Self-Attention without Mask
==================================================
...
==================================================
Example 2: Self-Attention with Padding Mask
==================================================
Padding Mask:
tensor([[1., 1., 1., 0.],
        [1., 1., 1., 1.]])
...
[[0.333 0.333 0.333 0.000]
 ...
 [0.333 0.333 0.333 0.000]
 [0.333 0.333 0.333 0.000]]
Note: Column 4 (PAD position) has all weights = 0
...
Note: Each row can only see itself and previous positions (upper triangle = 0)
```

![三种掩码对比](https://raw.gitcode.com/ZhengEnCi/knoweledges/raw/master/Transformer/05_chapter7_visualization.png)

- 每行分别展示：无掩码、Padding Mask、Causal Mask 三种情况
- 每种情况左列为热力图，右列为柱状图
- 柱状图清晰展示每个Query对不同Key的关注程度分布
