...
本文档深入解析位置编码中为什么使用 $e^{-\ln(10000) \times \frac{2i}{d_{\text{model}}}}$ 而不是直接计算 $\frac{1}{10000^{\frac{2i}{d_{\text{model}}}}}$，涵盖数值稳定性原理、浮点数溢出问题、实际代码对比测试，以及在深度学习中的最佳实践。通过理论与实践相结合的方式，帮助读者理解这个看似复杂的设计背后的精妙之处 🔢
