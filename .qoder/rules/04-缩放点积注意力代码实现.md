...
class ScaledDotProductAttention(nn.Module):
    ...
    # 前向传播计算缩放点积注意力
    # 参数: Q 查询矩阵 [batch_size, n_heads, seq_len_q, d_k], K 键矩阵 [batch_size, n_heads, seq_len_k, d_k], V 值矩阵 [batch_size, n_heads, seq_len_v, d_v], mask 可选掩码矩阵
    # 返回: output 注意力输出 [batch_size, n_heads, seq_len_q, d_v], attention_weights 注意力权重 [batch_size, n_heads, seq_len_q, seq_len_k]
