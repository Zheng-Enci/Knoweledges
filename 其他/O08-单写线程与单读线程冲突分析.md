...
<!-- 数学公式必须使用 LaTeX 格式 -->
$$
\text{next\_index} = (\text{current\_index} + 1) \mod \text{Capacity}
$$
<!-- 数学公式必须使用 LaTeX 格式 -->
...
<!-- 数学公式必须使用 LaTeX 格式 -->
$$
7 + 1 = 8 = 1 \times 8 + 0 \Rightarrow 8 \mod 8 = 0
$$
<!-- 数学公式必须使用 LaTeX 格式 -->
...
<!-- 数学公式必须使用 LaTeX 格式 -->
$$
\text{满} \iff (head + 1) \mod \text{Capacity} = tail
$$
<!-- 数学公式必须使用 LaTeX 格式 -->
...
<!-- 数学公式必须使用 LaTeX 格式 -->
$$
\text{index} \mod 2^n = \text{index} \ \& \ (2^n - 1)
$$
<!-- 数学公式必须使用 LaTeX 格式 -->
