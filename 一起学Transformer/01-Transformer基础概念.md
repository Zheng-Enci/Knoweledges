...
flowchart LR
    ...
    subgraph Encoder
    E1[Embedding] --> E2[Positional Encoding] --> E3[Multi-Head Attention] --> E4[Feed Forward]
    E3 --> E4
    end
    
    subgraph Decoder
    D1[Output Embedding] --> D2[Positional Encoding] --> D3[Masked Attention] --> D4[Cross Attention] --> D5[Feed Forward]
    end
