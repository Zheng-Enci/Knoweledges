...
在开始写代码之前，请确保你的环境中已经安装了 PyTorch。如果还没有安装，可以参考 [03ab-PyTorch安装教程](03ab-PyTorch安装教程.md)（[掘金](https://juejin.cn/post/7635465776091267122) / [CSDN](https://blog.csdn.net/2301_79239314/article/details/160747499)）。
...
假设输入形状为：
- Q: `[2, 4, 10, 64]`（batch=2, heads=4, seq_len=10, d_k=64）
- K: `[2, 4, 10, 64]`

则 `K.transpose(-2, -1)` 后形状为 `[2, 4, 64, 10]`，
`torch.matmul(Q, K.transpose(-2, -1))` 后形状为 `[2, 4, 10, 10]`。

这个 `[10, 10]` 的矩阵就是注意力分数矩阵，第 i 行第 j 列表示第 i 个查询对第 j 个键的关注程度。
...
> 💡 下一节我们将学习**多头注意力（Multi-Head Attention）**，看看如何把多个缩放点积注意力并行组合起来，获得更丰富的表示能力。

---

**参考资料：**

- [Transformer 代码剖析14 - 缩放点积注意力机制 (pytorch实现) -- CSDN](https://blog.csdn.net/lczdyx/article/details/145997920)
- [从零实现Transformer:第 2 部分 - 缩放点积注意力 -- CSDN](https://blog.csdn.net/flyfish1986/article/details/160566104)
- [PyTorch 官方 scaled_dot_product_attention 文档](https://pytorch.org/docs/main/generated/torch.nn.functional.scaled_dot_product_attention.html)
