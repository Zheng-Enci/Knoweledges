...
- [The Mathematics of Attention -- TeraSystems](https://www.terasystems.ai/blog-attention-math.html)
...
并在当前目录生成 `attention_heatmap.png` 文件，打开后可以看到如下热力图：

![注意力权重热力图](attention_heatmap.png)

**热力图解读**：

- **颜色越亮**（偏黄/白），表示注意力权重越高（如图中"学习"对"我"的注意力）
- **颜色越暗**（偏紫/黑），表示注意力权重越低
