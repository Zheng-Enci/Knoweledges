...
前面我们已经从概念和数学公式上理解了缩放点积注意力，现在我们要动手把它写出来！这一节会用 PyTorch 从零实现缩放点积注意力，并一步步拆解每行代码背后的原理 🛠️
...
在开始写代码之前，请确保你的环境中已经安装了 PyTorch。如果还没有安装，可以参考 [03ab-PyTorch安装教程](03ab-PyTorch安装教程.md)。
