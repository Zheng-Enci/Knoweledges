...
<div style="position: relative; width: 300px; height: 300px; border-left: 2px solid #333; border-bottom: 2px solid #333; margin: 20px;">
  ...
  <!-- 刻度 (范围: -1 到 1) -->
  <div style="position: absolute; left: -25px; top: 0%;">1</div>
  <div style="position: absolute; left: -25px; top: 50%;">0</div>
  <div style="position: absolute; left: -25px; bottom: 0%;">-1</div>
  
  <div style="position: absolute; bottom: -25px; left: 0%;">-1</div>
  <div style="position: absolute; bottom: -25px; left: 50%;">0</div>
  <div style="position: absolute; bottom: -25px; right: 0%;">1</div>
  
  <!-- 数据点 (范围: -1 到 1) -->
  <!-- A(0,1): left=50%, top=0% -->
  <div style="position: absolute; left: 50%; top: 0%; width: 20px; height: 20px; background: #4CAF50; border-radius: 50%; transform: translate(-50%, -50%);"></div>
  <div style="position: absolute; left: 50%; top: 0%; margin-left: 8px; margin-top: -5px; color: #333; font-size: 12px; font-weight: bold;">A(0,1)</div>
  
  <!-- B(1,1): left=100%, top=0% -->
  <div style="position: absolute; left: 100%; top: 0%; width: 20px; height: 20px; background: #F44336; border-radius: 50%; transform: translate(-50%, -50%);"></div>
  <div style="position: absolute; left: 100%; top: 0%; margin-left: 8px; margin-top: -5px; color: #333; font-size: 12px; font-weight: bold;">B(1,1)</div>
  
  <!-- C(0,0): left=50%, top=50% -->
  <div style="position: absolute; left: 50%; top: 50%; width: 20px; height: 20px; background: #F44336; border-radius: 50%; transform: translate(-50%, -50%);"></div>
  <div style="position: absolute; left: 50%; top: 50%; margin-left: 8px; margin-top: 8px; color: #333; font-size: 12px; font-weight: bold;">C(0,0)</div>
  
  <!-- D(1,0): left=100%, top=50% -->
  <div style="position: absolute; left: 100%; top: 50%; width: 20px; height: 20px; background: #4CAF50; border-radius: 50%; transform: translate(-50%, -50%);"></div>
  <div style="position: absolute; left: 100%; top: 50%; margin-left: 8px; margin-top: 8px; color: #333; font-size: 12px; font-weight: bold;">D(1,0)</div>
  
  <!-- 第一条线: x₁+x₂=0.5，从(-0.5,1)到(1,-0.5) -->
  <!-- 在图表中: left=25%, top=0% 到 left=100%, top=75% -->
  <div style="position: absolute; left: 25%; top: 0%; width: 106%; height: 2px; background: #2196F3; transform-origin: left center; transform: rotate(45deg);"></div>
  
  <!-- 第二条线: x₁+x₂=1.5，从(0.5,1)到(1,0.5) -->
  <!-- 延长到轴: 从(0,1.5)到(1.5,0)，在图表中: left=50%, top=-25% 到 left=125%, top=50% -->
  <div style="position: absolute; left: 50%; top: -25%; width: 106%; height: 2px; background: #2196F3; transform-origin: left center; transform: rotate(45deg);"></div>
</div>
