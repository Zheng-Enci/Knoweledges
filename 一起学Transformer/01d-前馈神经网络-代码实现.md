...
<div style="position: relative; width: 300px; height: 300px; border-left: 2px solid #333; border-bottom: 2px solid #333; margin: 20px;">
  ...
  <!-- 刻度 -->
  <div style="position: absolute; left: -25px; top: 0;">1.0</div>
  <div style="position: absolute; left: -25px; top: 50%;">0.5</div>
  <div style="position: absolute; left: -25px; bottom: 0;">0.0</div>
  <div style="position: absolute; bottom: -25px; left: 0;">0.0</div>
  <div style="position: absolute; bottom: -25px; left: 50%;">0.5</div>
  <div style="position: absolute; bottom: -25px; right: 0;">1.0</div>
  
  <!-- 数据点 -->
  <div style="position: absolute; left: 0; top: 0; width: 20px; height: 20px; background: #4CAF50; border-radius: 50%; transform: translate(-50%, -50%);"></div>
  <div style="position: absolute; left: 0; top: 0; margin-left: 5px; margin-top: 5px; color: #333; font-size: 12px;">A(0,1)</div>
  
  <div style="position: absolute; right: 0; top: 0; width: 20px; height: 20px; background: #F44336; border-radius: 50%; transform: translate(50%, -50%);"></div>
  <div style="position: absolute; right: 0; top: 0; margin-right: 5px; margin-top: 5px; color: #333; font-size: 12px;">B(1,1)</div>
  
  <div style="position: absolute; left: 0; bottom: 0; width: 20px; height: 20px; background: #F44336; border-radius: 50%; transform: translate(-50%, 50%);"></div>
  <div style="position: absolute; left: 0; bottom: 0; margin-left: 5px; margin-bottom: 5px; color: #333; font-size: 12px;">C(0,0)</div>
  
  <div style="position: absolute; right: 0; bottom: 0; width: 20px; height: 20px; background: #4CAF50; border-radius: 50%; transform: translate(50%, 50%);"></div>
  <div style="position: absolute; right: 0; bottom: 0; margin-right: 5px; margin-bottom: 5px; color: #333; font-size: 12px;">D(1,0)</div>
  
  <!-- 第一条线: x₁+x₂=0.5 -->
  <div style="position: absolute; left: 0; top: 50%; width: 50%; height: 2px; background: #2196F3; transform-origin: left center; transform: rotate(45deg);"></div>
  
  <!-- 第二条线: x₁+x₂=1.5 -->
  <div style="position: absolute; left: 50%; top: 0; width: 70%; height: 2px; background: #2196F3; transform-origin: left center; transform: rotate(45deg);"></div>
</div>

解决方案：用两条斜线分离

- 第一条线(x₁+x₂=0.5)：从(0,0.5)到(0.5,0)，分离🔴(C)
- 第二条线(x₁+x₂=1.5)：从(0.5,1)到(1,0.5)，分离🔴(B)
