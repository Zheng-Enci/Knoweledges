...
<div style="position: relative; width: 300px; height: 300px; border-left: 2px solid #333; border-bottom: 2px solid #333; margin: 20px;">
  ...
  <!-- 第二条线: x₁+x₂=1.5，从(-1,2.5)到(2.5,-1) -->
  <!-- 在图表中: left=0%, top=-16.66% 到 left=116.66%, top=100% -->
  <div style="position: absolute; left: 0%; top: -16.66%; width: 141%; height: 2px; background: #2196F3; transform-origin: left center; transform: rotate(45deg);"></div>
</div>
...
**隐藏层的作用：** 通过多层网络的组合，网络学习到了"弯曲"的决策边界。
