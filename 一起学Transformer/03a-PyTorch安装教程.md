...
GPU版本需要CUDA Toolkit的支持。首先用nvidia-smi查看你的显卡驱动支持什么版本的CUDA（上文已经查过了）。

根据搜索结果，2025年主流的CUDA版本是11.8和12.1/12.2。推荐安装11.8，兼容性最好。

**下载地址**：https://developer.nvidia.com/cuda-downloads

下载对应版本后，双击安装包，按照提示一路下一步即可。安装完成后，打开命令提示符验证：
...
下载地址：https://developer.nvidia.com/cudnn/download

下载对应CUDA版本的cuDNN，解压后把文件复制到CUDA安装目录即可。这步不是必须的，但有的话会更好。
